/* Generated by Cython 0.15.1 on Mon Jul 30 15:30:01 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__neighborSuperpixels
#define __PYX_HAVE_API__neighborSuperpixels
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_19neighborSuperpixels_UINT8;
...
/* Module declarations from 'neighborSuperpixels' */
static CYTHON_INLINE PyObject *__pyx_f_19neighborSuperpixels_getNeighborEdges(PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_19neighborSuperpixels_getNeighborProfiles(PyArrayObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_19neighborSuperpixels_UINT8 = { "UINT8", NULL, sizeof(__pyx_t_19neighborSuperpixels_UINT8), 'U' };
#define __Pyx_MODULE_NAME "neighborSuperpixels"
int __pyx_module_is_main_neighborSuperpixels = 0;

/* Implementation of 'neighborSuperpixels' */
...
static PyObject *__pyx_pf_19neighborSuperpixels_getNeighborEdges(PyObject *__pyx_self, PyObject *__pyx_v_regions); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_19neighborSuperpixels_getNeighborEdges(PyArrayObject *__pyx_v_regions, int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_ind;
  int __pyx_v_height;
  ...
  __pyx_t_19neighborSuperpixels_UINT8 *__pyx_v_regions_c;
  long __pyx_v_ind2;
  long __pyx_v_ind3;
  Py_buffer __pyx_bstruct_regions;
  Py_ssize_t __pyx_bstride_0_regions = 0;
  Py_ssize_t __pyx_bstride_1_regions = 0;
  Py_ssize_t __pyx_bshape_0_regions = 0;
  Py_ssize_t __pyx_bshape_1_regions = 0;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("getNeighborEdges");
  __pyx_bstruct_regions.buf = NULL;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_regions, (PyObject*)__pyx_v_regions, &__Pyx_TypeInfo_nn___pyx_t_19neighborSuperpixels_UINT8, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_regions = __pyx_bstruct_regions.strides[0]; __pyx_bstride_1_regions = __pyx_bstruct_regions.strides[1];
  __pyx_bshape_0_regions = __pyx_bstruct_regions.shape[0]; __pyx_bshape_1_regions = __pyx_bstruct_regions.shape[1];

  /* "neighborSuperpixels.pyx":18
 * cpdef inline list getNeighborEdges(np.ndarray[UINT8, ndim=2] regions):
 * 	cdef int x,y, ind
 * 	cdef int height = regions.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_v_regions_c = ((__pyx_t_19neighborSuperpixels_UINT8 *)__pyx_v_regions->data);

  /* "neighborSuperpixels.pyx":25
 * 
 * 	# Look left and above current node. If it is a different label, add to edges.
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_regions);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("neighborSuperpixels.getNeighborEdges", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_regions);
...
static PyObject *__pyx_pf_19neighborSuperpixels_getNeighborEdges(PyObject *__pyx_self, PyObject *__pyx_v_regions); /*proto*/
static PyObject *__pyx_pf_19neighborSuperpixels_getNeighborEdges(PyObject *__pyx_self, PyObject *__pyx_v_regions) {
  Py_buffer __pyx_bstruct_regions;
  Py_ssize_t __pyx_bstride_0_regions = 0;
  Py_ssize_t __pyx_bstride_1_regions = 0;
  Py_ssize_t __pyx_bshape_0_regions = 0;
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_19neighborSuperpixels_getNeighborEdges(((PyArrayObject *)__pyx_v_regions), 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyObject *__pyx_pf_19neighborSuperpixels_1getNeighborProfiles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_19neighborSuperpixels_getNeighborProfiles(PyArrayObject *__pyx_v_im, PyObject *__pyx_v_edges, PyObject *__pyx_v_edgePositions, int __pyx_skip_dispatch) {
  int __pyx_v_ind;
  int __pyx_v_height;
  int __pyx_v_width;
  __pyx_t_19neighborSuperpixels_UINT8 *__pyx_v_im_c;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("getNeighborProfiles");
  __pyx_bstruct_im.buf = NULL;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_im, (PyObject*)__pyx_v_im, &__Pyx_TypeInfo_nn___pyx_t_19neighborSuperpixels_UINT8, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_v_im_c = ((__pyx_t_19neighborSuperpixels_UINT8 *)__pyx_v_im->data);

  /* "neighborSuperpixels.pyx":46
 * 	cdef UINT8* im_c = <UINT8*>im.data
 * 
 * 	cdef list edgeProfiles = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
    if (unlikely(((PyObject *)__pyx_v_edgeProfiles) == Py_None)) {
 ...
 */
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("neighborSuperpixels.getNeighborProfiles", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_im);
...
static PyObject *__pyx_pf_19neighborSuperpixels_1getNeighborProfiles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_19neighborSuperpixels_1getNeighborProfiles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "getNeighborProfiles") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  __pyx_bshape_0_im = __pyx_bstruct_im.shape[0]; __pyx_bshape_1_im = __pyx_bstruct_im.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_19neighborSuperpixels_getNeighborProfiles(__pyx_v_im, __pyx_v_edges, __pyx_v_edgePositions, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("getNeighborEdges"), (PyCFunction)__pyx_pf_19neighborSuperpixels_getNeighborEdges, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("getNeighborProfiles"), (PyCFunction)__pyx_pf_19neighborSuperpixels_1getNeighborProfiles, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_neighborSuperpixels(void)");
  ...
  if (__pyx_module_is_main_neighborSuperpixels) {
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init neighborSuperpixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init neighborSuperpixels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
