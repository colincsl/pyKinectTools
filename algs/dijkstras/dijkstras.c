/* Generated by Cython 0.15.1 on Mon Jul 30 10:32:00 2012 */
...
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_dim2ind(int __pyx_v_i, int __pyx_v_j, int __pyx_v_rezX, int __pyx_v_rezY) {
  ...
  __pyx_r = ((__pyx_v_j * __pyx_v_rezX) + __pyx_v_i);
  goto __pyx_L0;
 ...
 * 						current[1] = y
 */
          __pyx_t_17 = (((__pyx_v_visitMat_c[__pyx_v_x])[__pyx_v_y]) == 1);
          if (__pyx_t_17) {
 ...
 * 			# if visitMat_c[neigh[0][j]][neigh[1][j]] == OUTOFBOUNDS:
 */
      ((__pyx_v_visitMat_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]) = __pyx_f_14dijkstrasGraph_int_max(1, ((__pyx_v_visitMat_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]));
 ...
 */
      ((__pyx_v_dists2Tot_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]) = __pyx_f_14dijkstrasGraph_int_min(((__pyx_v_dists2Tot_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]), (((((__pyx_v_dists2_c[(__pyx_v_current[0])])[(__pyx_v_current[1])])[__pyx_v_j]) + __pyx_v_currentCost) + 1));
    }
 ...
 * 					tmpMin = tmp
 */
        __pyx_v_tmp = (((__pyx_v_dists2Tot_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]) + ((__pyx_v_visitMat_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]));
 ...
 */
    ...
    __pyx_t_2 = PyInt_FromLong(((__pyx_v_trail[__pyx_v_x])[0])); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = PyInt_FromLong(((__pyx_v_trail[__pyx_v_x])[1])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_2 = 0;
    __pyx_t_3 = 0;
    __pyx_t_23 = PyList_Append(__pyx_v_trailOut, ((PyObject *)__pyx_t_1)); if (unlikely(__pyx_t_23 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(((PyObject *)__pyx_t_1)); __pyx_t_1 = 0;
  }
