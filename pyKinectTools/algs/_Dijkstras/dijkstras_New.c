/* Generated by Cython 0.16 on Thu Aug  9 13:52:49 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__dijkstrasGraphNew
#define __PYX_HAVE_API__dijkstrasGraphNew
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_uint16_t __pyx_t_17dijkstrasGraphNew_UINT16;

/* "dijkstras_New.pyx":15
 * 
 * ctypedef np.uint16_t UINT16
 * ctypedef np.int16_t INT16             # <<<<<<<<<<<<<<
 * ctypedef np.uint8_t UINT8
 * 
 */
typedef __pyx_t_5numpy_int16_t __pyx_t_17dijkstrasGraphNew_INT16;

/* "dijkstras_New.pyx":16
 * ctypedef np.uint16_t UINT16
 * ctypedef np.int16_t INT16
 * ctypedef np.uint8_t UINT8             # <<<<<<<<<<<<<<
 * 
 * np.import_array()
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_17dijkstrasGraphNew_UINT8;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'dijkstrasGraphNew' */
static CYTHON_INLINE int __pyx_f_17dijkstrasGraphNew_int_max(int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_17dijkstrasGraphNew_int_min(int, int); /*proto*/
static CYTHON_INLINE void __pyx_f_17dijkstrasGraphNew_ind2dim(int, int *, int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_17dijkstrasGraphNew_dim2ind(int, int, int, int); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_17dijkstrasGraphNew_graphDijkstras(PyArrayObject *, PyArrayObject *, PyArrayObject *, PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT16 = { "UINT16", NULL, sizeof(__pyx_t_17dijkstrasGraphNew_UINT16), { 0 }, 0, 'U', IS_UNSIGNED(__pyx_t_17dijkstrasGraphNew_UINT16), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT8 = { "UINT8", NULL, sizeof(__pyx_t_17dijkstrasGraphNew_UINT8), { 0 }, 0, 'U', IS_UNSIGNED(__pyx_t_17dijkstrasGraphNew_UINT8), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_INT16 = { "INT16", NULL, sizeof(__pyx_t_17dijkstrasGraphNew_INT16), { 0 }, 0, 'I', IS_UNSIGNED(__pyx_t_17dijkstrasGraphNew_INT16), 0 };
#define __Pyx_MODULE_NAME "dijkstrasGraphNew"
int __pyx_module_is_main_dijkstrasGraphNew = 0;

/* Implementation of 'dijkstrasGraphNew' */
static PyObject *__pyx_builtin_xrange;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_17dijkstrasGraphNew_graphDijkstras(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_distsMat, PyArrayObject *__pyx_v_visitMat, PyArrayObject *__pyx_v_depthMat, PyArrayObject *__pyx_v_current_); /* proto */
...
static CYTHON_INLINE int __pyx_f_17dijkstrasGraphNew_int_max(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
...
static CYTHON_INLINE int __pyx_f_17dijkstrasGraphNew_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
...
static CYTHON_INLINE void __pyx_f_17dijkstrasGraphNew_ind2dim(int __pyx_v_ind, int *__pyx_v_current, int __pyx_v_rezX, CYTHON_UNUSED int __pyx_v_rezY) {
  __Pyx_RefNannyDeclarations
  int __pyx_lineno = 0;
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("dijkstrasGraphNew.ind2dim", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "dijkstras_New.pyx":27
 * 	return
 * 	# return [(ind/rezX), ind-rezX*((ind/rezX))]
 * cdef inline int dim2ind(int i, int j, int rezX, int rezY):             # <<<<<<<<<<<<<<
 * 	return (i*rezX+j)
...
static CYTHON_INLINE int __pyx_f_17dijkstrasGraphNew_dim2ind(int __pyx_v_i, int __pyx_v_j, int __pyx_v_rezX, CYTHON_UNUSED int __pyx_v_rezY) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dim2ind", 0);

  /* "dijkstras_New.pyx":28
 * 	# return [(ind/rezX), ind-rezX*((ind/rezX))]
 * cdef inline int dim2ind(int i, int j, int rezX, int rezY):
 * 	return (i*rezX+j)             # <<<<<<<<<<<<<<
 * 	# return (j*rezX+i)
...
static PyObject *__pyx_pw_17dijkstrasGraphNew_1graphDijkstras(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_17dijkstrasGraphNew_graphDijkstras(PyArrayObject *__pyx_v_distsMat, PyArrayObject *__pyx_v_visitMat, PyArrayObject *__pyx_v_depthMat, PyArrayObject *__pyx_v_current_, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  int __pyx_v_tmpX;
  int __pyx_v_tmpY;
  ...
  __pyx_t_17dijkstrasGraphNew_UINT16 __pyx_v_distsMat_c[307200];
  long __pyx_v_y;
  long __pyx_v_x;
  __pyx_t_17dijkstrasGraphNew_UINT8 __pyx_v_visitMat_c[307200];
  __pyx_t_17dijkstrasGraphNew_UINT16 __pyx_v_depthMat_c[307200];
  int __pyx_v_maxVal;
  int __pyx_v_maxInd;
  ...
  __pyx_pybuffernd_current_.rcbuffer = &__pyx_pybuffer_current_;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_distsMat.rcbuffer->pybuffer, (PyObject*)__pyx_v_distsMat, &__Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT16, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_visitMat.rcbuffer->pybuffer, (PyObject*)__pyx_v_visitMat, &__Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT8, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_current_.rcbuffer->pybuffer, (PyObject*)__pyx_v_current_, &__Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_INT16, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
 ...
 */
  __pyx_t_1 = 0;
  (__pyx_v_current[0]) = (*__Pyx_BufPtrCContig1d(__pyx_t_17dijkstrasGraphNew_INT16 *, __pyx_pybuffernd_current_.rcbuffer->pybuffer.buf, __pyx_t_1, __pyx_pybuffernd_current_.diminfo[0].strides));

  /* "dijkstras_New.pyx":53
 * 	cdef int current[2]
 * 	current[0] = current_[0]
 * 	current[1] = current_[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = 1;
  (__pyx_v_current[1]) = (*__Pyx_BufPtrCContig1d(__pyx_t_17dijkstrasGraphNew_INT16 *, __pyx_pybuffernd_current_.rcbuffer->pybuffer.buf, __pyx_t_2, __pyx_pybuffernd_current_.diminfo[0].strides));

  /* "dijkstras_New.pyx":55
 * 	current[1] = current_[1]
 * 
 * 	cdef int TOUCHED=1, VISITED=254, OUTOFBOUNDS=255, MAXVALUE=32000             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_7 = __pyx_v_y;
      __pyx_t_8 = __pyx_v_x;
      (__pyx_v_distsMat_c[__pyx_v_i]) = (*__Pyx_BufPtrCContig2d(__pyx_t_17dijkstrasGraphNew_UINT16 *, __pyx_pybuffernd_distsMat.rcbuffer->pybuffer.buf, __pyx_t_7, __pyx_pybuffernd_distsMat.diminfo[0].strides, __pyx_t_8, __pyx_pybuffernd_distsMat.diminfo[1].strides));
    }
  }

  /* "dijkstras_New.pyx":81
 * 			distsMat_c[i] = distsMat[y,x]
 * 	cdef UINT8 visitMat_c[307200]
 * 	for y in xrange(height):             # <<<<<<<<<<<<<<
 * 		for x in xrange(width):
 ...
 */
      ...
      (__pyx_v_visitMat_c[__pyx_v_i]) = (*__Pyx_BufPtrCContig2d(__pyx_t_17dijkstrasGraphNew_UINT8 *, __pyx_pybuffernd_visitMat.rcbuffer->pybuffer.buf, __pyx_t_9, __pyx_pybuffernd_visitMat.diminfo[0].strides, __pyx_t_10, __pyx_pybuffernd_visitMat.diminfo[1].strides));
    }
  }

  /* "dijkstras_New.pyx":86
 * 			visitMat_c[i] = visitMat[y,x]
 * 	cdef UINT16 depthMat_c[307200]
 * 	for y in xrange(height):             # <<<<<<<<<<<<<<
 * 		for x in xrange(width):
 ...
 */
      ...
      (__pyx_v_depthMat_c[__pyx_v_i]) = (*__Pyx_BufPtrCContig2d(__pyx_t_17dijkstrasGraphNew_UINT16 *, __pyx_pybuffernd_depthMat.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_depthMat.diminfo[0].strides, __pyx_t_12, __pyx_pybuffernd_depthMat.diminfo[1].strides));
    }
  }

  /* "dijkstras_New.pyx":98
 * 
 * 
 ...
 */
  __pyx_v_currentInd = __pyx_f_17dijkstrasGraphNew_dim2ind((__pyx_v_current[0]), (__pyx_v_current[1]), __pyx_v_width, __pyx_v_height);

  /* "dijkstras_New.pyx":101
 * 
 * 	# Set border to OUTOFBOUNDS
 ...
 */
    __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(__pyx_v_i, 0, __pyx_v_width, __pyx_v_height);

    /* "dijkstras_New.pyx":103
 * 	for i in range(0,height):
 * 		tmpInd = dim2ind(i, 0, width, height)
 * 		visitMat_c[tmpInd] = OUTOFBOUNDS             # <<<<<<<<<<<<<<
 * 		tmpInd = dim2ind(i, width, width, height)
 ...
 */
    __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(__pyx_v_i, __pyx_v_width, __pyx_v_width, __pyx_v_height);

    /* "dijkstras_New.pyx":105
 * 		visitMat_c[tmpInd] = OUTOFBOUNDS
 * 		tmpInd = dim2ind(i, width, width, height)
 * 		visitMat_c[tmpInd] = OUTOFBOUNDS             # <<<<<<<<<<<<<<
 * 	for i in range(0,width):
 ...
 */
    __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(0, __pyx_v_i, __pyx_v_width, __pyx_v_height);

    /* "dijkstras_New.pyx":108
 * 	for i in range(0,width):
 * 		tmpInd = dim2ind(0, i, width, height)
 * 		visitMat_c[tmpInd] = OUTOFBOUNDS             # <<<<<<<<<<<<<<
 * 		tmpInd = dim2ind(height, i, width, height)
 ...
 * 
 */
    __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(__pyx_v_height, __pyx_v_i, __pyx_v_width, __pyx_v_height);

    /* "dijkstras_New.pyx":110
 * 		visitMat_c[tmpInd] = OUTOFBOUNDS
 * 		tmpInd = dim2ind(height, i, width, height)
 * 		visitMat_c[tmpInd] = OUTOFBOUNDS             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
    __pyx_f_17dijkstrasGraphNew_ind2dim(__pyx_v_currentInd, __pyx_v_current, __pyx_v_width, __pyx_v_height);

    /* "dijkstras_New.pyx":116
 * 		currentCost = distsMat_c[currentInd]
 * 		ind2dim(currentInd, current, width, height)
 * 		visitMat_c[currentInd] = VISITED             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
          __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(((__pyx_v_current[0]) + __pyx_v_i), ((__pyx_v_current[1]) + __pyx_v_j), __pyx_v_width, __pyx_v_height);

          /* "dijkstras_New.pyx":126
 * 				if not (i == 0 and j == 0):
 * 					tmpInd = dim2ind(current[0]+i, current[1]+j, width, height)
 * 					if visitMat_c[tmpInd] < VISITED:             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
            (__pyx_v_distsMat_c[__pyx_v_tmpInd]) = __pyx_f_17dijkstrasGraphNew_int_min((__pyx_v_distsMat_c[__pyx_v_tmpInd]), ((__pyx_v_currentCost + __pyx_v_gradient) + 1));

            /* "dijkstras_New.pyx":131
 * 						# distsMat_c[tmpInd] = int_min(distsMat_c[tmpInd], currentCost + 1)
 * 						distsMat_c[tmpInd] = int_min(distsMat_c[tmpInd], currentCost + gradient + 1)
 * 						visitMat_c[tmpInd] = int_max(visitMat_c[tmpInd], TOUCHED)             # <<<<<<<<<<<<<<
 * 
 * 						if visitMat_c[tmpInd] != VISITED:
 */
            (__pyx_v_visitMat_c[__pyx_v_tmpInd]) = __pyx_f_17dijkstrasGraphNew_int_max((__pyx_v_visitMat_c[__pyx_v_tmpInd]), __pyx_v_TOUCHED);

            /* "dijkstras_New.pyx":133
 * 						visitMat_c[tmpInd] = int_max(visitMat_c[tmpInd], TOUCHED)
 * 
 * 						if visitMat_c[tmpInd] != VISITED:             # <<<<<<<<<<<<<<
 ...
 */
          __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(__pyx_v_tmpY, __pyx_v_tmpX, __pyx_v_width, __pyx_v_height);

          /* "dijkstras_New.pyx":154
 * 					tmpInd = dim2ind(tmpY, tmpX, width, height)
 * 
 * 					if visitMat_c[tmpInd] == TOUCHED:             # <<<<<<<<<<<<<<
 * 						currentInd = tmpInd
 ...
 */
      __pyx_v_tmpInd = __pyx_f_17dijkstrasGraphNew_dim2ind(__pyx_v_y, __pyx_v_x, __pyx_v_width, __pyx_v_height);

      /* "dijkstras_New.pyx":173
 * 		for x in range(width-1):
 * 			tmpInd = dim2ind(y, x, width, height)
 * 			if distsMat_c[tmpInd] > maxVal and visitMat_c[tmpInd] == VISITED:             # <<<<<<<<<<<<<<
 * 				maxVal = distsMat_c[tmpInd]
 ...
 * 	currentInd = maxInd
 */
  __pyx_f_17dijkstrasGraphNew_ind2dim(__pyx_v_maxInd, __pyx_v_current, __pyx_v_width, __pyx_v_height);

  /* "dijkstras_New.pyx":178
 * 	ind2dim(maxInd, current, width, height)
 * 
 * 	currentInd = maxInd             # <<<<<<<<<<<<<<
 ...
 */
    __pyx_f_17dijkstrasGraphNew_ind2dim(__pyx_v_argGradient, __pyx_v_current, __pyx_v_width, __pyx_v_height);

    /* "dijkstras_New.pyx":208
 * 
 * 		ind2dim(argGradient, current, width, height)
 * 		currentInd = argGradient             # <<<<<<<<<<<<<<
 * 		currentVal = distsMat_c[argGradient]
 ...
 */
      ...
      *__Pyx_BufPtrCContig2d(__pyx_t_17dijkstrasGraphNew_UINT16 *, __pyx_pybuffernd_distsMat.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_distsMat.diminfo[0].strides, __pyx_t_17, __pyx_pybuffernd_distsMat.diminfo[1].strides) = (__pyx_v_distsMat_c[__pyx_v_i]);
    }
  }

  /* "dijkstras_New.pyx":258
 * 			i = y*width + x
 * 			distsMat[y,x] = distsMat_c[i]
 * 	for y in xrange(height):             # <<<<<<<<<<<<<<
 * 		for x in xrange(width):
 ...
 */
    ...
    *__Pyx_BufPtrCContig2d(__pyx_t_17dijkstrasGraphNew_UINT8 *, __pyx_pybuffernd_visitMat.rcbuffer->pybuffer.buf, __pyx_t_6, __pyx_pybuffernd_visitMat.diminfo[0].strides, __pyx_t_23, __pyx_pybuffernd_visitMat.diminfo[1].strides) = (__pyx_v_visitMat_c[__pyx_v_i]);
  }

  /* "dijkstras_New.pyx":262
 * 			i = y*width + x
 * 		visitMat[y,x] = visitMat_c[i]
 * 	for y in xrange(height):             # <<<<<<<<<<<<<<
 * 		for x in xrange(width):
 ...
 */
    ...
    *__Pyx_BufPtrCContig2d(__pyx_t_17dijkstrasGraphNew_UINT16 *, __pyx_pybuffernd_depthMat.rcbuffer->pybuffer.buf, __pyx_t_24, __pyx_pybuffernd_depthMat.diminfo[0].strides, __pyx_t_25, __pyx_pybuffernd_depthMat.diminfo[1].strides) = (__pyx_v_depthMat_c[__pyx_v_i]);
  }

  /* "dijkstras_New.pyx":269
 * 
 * 
 * 	return trailOut             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("dijkstrasGraphNew.graphDijkstras", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_current_.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_17dijkstrasGraphNew_1graphDijkstras(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_17dijkstrasGraphNew_graphDijkstras[] = "\n\tInputs:\n\t\tdistsMat\n\t\tvisitMat\n\t\tdists2\n\t\tcurrent_\n\tOutputs:\n\t";
static PyObject *__pyx_pw_17dijkstrasGraphNew_1graphDijkstras(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_r = __pyx_pf_17dijkstrasGraphNew_graphDijkstras(__pyx_self, __pyx_v_distsMat, __pyx_v_visitMat, __pyx_v_depthMat, __pyx_v_current_);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_17dijkstrasGraphNew_graphDijkstras(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_distsMat, PyArrayObject *__pyx_v_visitMat, PyArrayObject *__pyx_v_depthMat, PyArrayObject *__pyx_v_current_) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_current_;
  __Pyx_Buffer __pyx_pybuffer_current_;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_depthMat;
  __Pyx_Buffer __pyx_pybuffer_depthMat;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_distsMat.rcbuffer->pybuffer, (PyObject*)__pyx_v_distsMat, &__Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT16, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_distsMat.diminfo[0].strides = __pyx_pybuffernd_distsMat.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_distsMat.diminfo[0].shape = __pyx_pybuffernd_distsMat.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_distsMat.diminfo[1].strides = __pyx_pybuffernd_distsMat.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_distsMat.diminfo[1].shape = __pyx_pybuffernd_distsMat.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_visitMat.rcbuffer->pybuffer, (PyObject*)__pyx_v_visitMat, &__Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT8, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_visitMat.diminfo[0].strides = __pyx_pybuffernd_visitMat.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_visitMat.diminfo[0].shape = __pyx_pybuffernd_visitMat.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_visitMat.diminfo[1].strides = __pyx_pybuffernd_visitMat.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_visitMat.diminfo[1].shape = __pyx_pybuffernd_visitMat.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_depthMat.rcbuffer->pybuffer, (PyObject*)__pyx_v_depthMat, &__Pyx_TypeInfo_nn___pyx_t_17dijkstrasGraphNew_UINT16, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_pybuffernd_depthMat.diminfo[0].strides = __pyx_pybuffernd_depthMat.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_depthMat.diminfo[0].shape = __pyx_pybuffernd_depthMat.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_depthMat.diminfo[1].strides = __pyx_pybuffernd_depthMat.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_depthMat.diminfo[1].shape = __pyx_pybuffernd_depthMat.rcbuffer->pybuffer.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_17dijkstrasGraphNew_graphDijkstras(__pyx_v_distsMat, __pyx_v_visitMat, __pyx_v_depthMat, __pyx_v_current_, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 36; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("graphDijkstras"), (PyCFunction)__pyx_pw_17dijkstrasGraphNew_1graphDijkstras, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(__pyx_doc_17dijkstrasGraphNew_graphDijkstras)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  if (__pyx_module_is_main_dijkstrasGraphNew) {
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init dijkstrasGraphNew", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dijkstrasGraphNew");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
