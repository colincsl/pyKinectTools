/* Generated by Cython 0.15.1 on Tue Aug  7 11:33:21 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__dijkstrasGraph
#define __PYX_HAVE_API__dijkstrasGraph
#include "stdio.h"
#include "stdlib.h"
 ...
 */
typedef __pyx_t_5numpy_uint16_t __pyx_t_14dijkstrasGraph_UINT16;
 ...
 * 
 */
typedef __pyx_t_5numpy_int16_t __pyx_t_14dijkstrasGraph_INT16;
 ...
 * np.import_array()
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_14dijkstrasGraph_UINT8;
...
/* Module declarations from 'dijkstrasGraph' */
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_int_max(int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_int_min(int, int); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_14dijkstrasGraph_ind2dim(int, int, int); /*proto*/
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_dim2ind(int, int, int, int); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_14dijkstrasGraph_graphDijkstras(PyArrayObject *, PyArrayObject *, PyArrayObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_INT16 = { "INT16", NULL, sizeof(__pyx_t_14dijkstrasGraph_INT16), 'I' };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_UINT8 = { "UINT8", NULL, sizeof(__pyx_t_14dijkstrasGraph_UINT8), 'U' };
#define __Pyx_MODULE_NAME "dijkstrasGraph"
int __pyx_module_is_main_dijkstrasGraph = 0;

/* Implementation of 'dijkstrasGraph' */
...
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_int_max(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
...
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_int_min(int __pyx_v_a, int __pyx_v_b) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
...
static CYTHON_INLINE PyObject *__pyx_f_14dijkstrasGraph_ind2dim(int __pyx_v_ind, int __pyx_v_rezX, int __pyx_v_rezY) {
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("ind2dim");
 ...
 */
  ...
  __Pyx_AddTraceback("dijkstrasGraph.ind2dim", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static CYTHON_INLINE int __pyx_f_14dijkstrasGraph_dim2ind(int __pyx_v_i, int __pyx_v_j, int __pyx_v_rezX, int __pyx_v_rezY) {
  int __pyx_r;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("dim2ind");
...
static PyObject *__pyx_pf_14dijkstrasGraph_graphDijkstras(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_14dijkstrasGraph_graphDijkstras(PyArrayObject *__pyx_v_dists2Tot, PyArrayObject *__pyx_v_visitMat, PyArrayObject *__pyx_v_dists2, PyObject *__pyx_v_current_, int __pyx_skip_dispatch) {
  unsigned int __pyx_v_currentCost;
  unsigned int __pyx_v_direc;
  unsigned int __pyx_v_prevDirec;
  ...
  __pyx_t_14dijkstrasGraph_INT16 __pyx_v_dists2_c[720][480][4];
  __pyx_t_14dijkstrasGraph_INT16 __pyx_v_dists2Tot_c[720][480];
  __pyx_t_14dijkstrasGraph_UINT8 __pyx_v_visitMat_c[720][480];
  ...
  Py_buffer __pyx_bstruct_dists2;
  Py_ssize_t __pyx_bstride_0_dists2 = 0;
  Py_ssize_t __pyx_bstride_1_dists2 = 0;
  Py_ssize_t __pyx_bstride_2_dists2 = 0;
  Py_ssize_t __pyx_bshape_0_dists2 = 0;
  Py_ssize_t __pyx_bshape_1_dists2 = 0;
  Py_ssize_t __pyx_bshape_2_dists2 = 0;
  Py_buffer __pyx_bstruct_visitMat;
  Py_ssize_t __pyx_bstride_0_visitMat = 0;
  Py_ssize_t __pyx_bstride_1_visitMat = 0;
  Py_ssize_t __pyx_bshape_0_visitMat = 0;
  Py_ssize_t __pyx_bshape_1_visitMat = 0;
  Py_buffer __pyx_bstruct_dists2Tot;
  Py_ssize_t __pyx_bstride_0_dists2Tot = 0;
  Py_ssize_t __pyx_bstride_1_dists2Tot = 0;
  Py_ssize_t __pyx_bshape_0_dists2Tot = 0;
  Py_ssize_t __pyx_bshape_1_dists2Tot = 0;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  __Pyx_RefNannySetupContext("graphDijkstras");
  __Pyx_TraceCall("graphDijkstras", __pyx_f[0], 27);
  __pyx_bstruct_dists2Tot.buf = NULL;
  __pyx_bstruct_visitMat.buf = NULL;
  __pyx_bstruct_dists2.buf = NULL;
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dists2Tot, (PyObject*)__pyx_v_dists2Tot, &__Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_INT16, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dists2Tot = __pyx_bstruct_dists2Tot.strides[0]; __pyx_bstride_1_dists2Tot = __pyx_bstruct_dists2Tot.strides[1];
  __pyx_bshape_0_dists2Tot = __pyx_bstruct_dists2Tot.shape[0]; __pyx_bshape_1_dists2Tot = __pyx_bstruct_dists2Tot.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_visitMat, (PyObject*)__pyx_v_visitMat, &__Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_UINT8, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_visitMat = __pyx_bstruct_visitMat.strides[0]; __pyx_bstride_1_visitMat = __pyx_bstruct_visitMat.strides[1];
  __pyx_bshape_0_visitMat = __pyx_bstruct_visitMat.shape[0]; __pyx_bshape_1_visitMat = __pyx_bstruct_visitMat.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dists2, (PyObject*)__pyx_v_dists2, &__Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_INT16, PyBUF_FORMAT| PyBUF_STRIDES, 3, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dists2 = __pyx_bstruct_dists2.strides[0]; __pyx_bstride_1_dists2 = __pyx_bstruct_dists2.strides[1]; __pyx_bstride_2_dists2 = __pyx_bstruct_dists2.strides[2];
  __pyx_bshape_0_dists2 = __pyx_bstruct_dists2.shape[0]; __pyx_bshape_1_dists2 = __pyx_bstruct_dists2.shape[1]; __pyx_bshape_2_dists2 = __pyx_bstruct_dists2.shape[2];
 ...
 */
        ...
        (((__pyx_v_dists2_c[__pyx_v_x])[__pyx_v_y])[__pyx_v_i]) = (*__Pyx_BufPtrStrided3d(__pyx_t_14dijkstrasGraph_INT16 *, __pyx_bstruct_dists2.buf, __pyx_t_9, __pyx_bstride_0_dists2, __pyx_t_10, __pyx_bstride_1_dists2, __pyx_t_11, __pyx_bstride_2_dists2));
      }
    }
  }
 ...
 */
      ...
      ((__pyx_v_dists2Tot_c[__pyx_v_x])[__pyx_v_y]) = (*__Pyx_BufPtrStrided2d(__pyx_t_14dijkstrasGraph_INT16 *, __pyx_bstruct_dists2Tot.buf, __pyx_t_8, __pyx_bstride_0_dists2Tot, __pyx_t_12, __pyx_bstride_1_dists2Tot));
 ...
 */
      ...
      ((__pyx_v_visitMat_c[__pyx_v_x])[__pyx_v_y]) = (*__Pyx_BufPtrStrided2d(__pyx_t_14dijkstrasGraph_UINT8 *, __pyx_bstruct_visitMat.buf, __pyx_t_13, __pyx_bstride_0_visitMat, __pyx_t_14, __pyx_bstride_1_visitMat));
    }
  }
 ...
 */
      ((__pyx_v_visitMat_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]) = __pyx_f_14dijkstrasGraph_int_max(__pyx_v_TOUCHED, ((__pyx_v_visitMat_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]));
 ...
 * 
 */
      ((__pyx_v_dists2Tot_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]) = __pyx_f_14dijkstrasGraph_int_min(((__pyx_v_dists2Tot_c[((__pyx_v_neigh[0])[__pyx_v_j])])[((__pyx_v_neigh[1])[__pyx_v_j])]), ((((__pyx_v_dists2_c[(__pyx_v_current[0])])[(__pyx_v_current[1])])[__pyx_v_j]) + __pyx_v_currentCost));
    }
 ...
 * 
 */
    if (unlikely(((PyObject *)__pyx_v_trailOut) == Py_None)) {
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_14dijkstrasGraph_INT16 *, __pyx_bstruct_dists2Tot.buf, __pyx_t_24, __pyx_bstride_0_dists2Tot, __pyx_t_25, __pyx_bstride_1_dists2Tot) = ((__pyx_v_dists2Tot_c[__pyx_v_x])[__pyx_v_y]);
 ...
 */
      ...
      *__Pyx_BufPtrStrided2d(__pyx_t_14dijkstrasGraph_UINT8 *, __pyx_bstruct_visitMat.buf, __pyx_t_26, __pyx_bstride_0_visitMat, __pyx_t_27, __pyx_bstride_1_visitMat) = ((__pyx_v_visitMat_c[__pyx_v_x])[__pyx_v_y]);
    }
  }
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_dists2);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_visitMat);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_dists2Tot);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("dijkstrasGraph.graphDijkstras", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_dists2);
...
static PyObject *__pyx_pf_14dijkstrasGraph_graphDijkstras(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pf_14dijkstrasGraph_graphDijkstras(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "graphDijkstras") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_dists2Tot, (PyObject*)__pyx_v_dists2Tot, &__Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_INT16, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_dists2Tot = __pyx_bstruct_dists2Tot.strides[0]; __pyx_bstride_1_dists2Tot = __pyx_bstruct_dists2Tot.strides[1];
  __pyx_bshape_0_dists2Tot = __pyx_bstruct_dists2Tot.shape[0]; __pyx_bshape_1_dists2Tot = __pyx_bstruct_dists2Tot.shape[1];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_visitMat, (PyObject*)__pyx_v_visitMat, &__Pyx_TypeInfo_nn___pyx_t_14dijkstrasGraph_UINT8, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_visitMat = __pyx_bstruct_visitMat.strides[0]; __pyx_bstride_1_visitMat = __pyx_bstruct_visitMat.strides[1];
  __pyx_bshape_0_visitMat = __pyx_bstruct_visitMat.shape[0]; __pyx_bshape_1_visitMat = __pyx_bstruct_visitMat.shape[1];
  {
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_14dijkstrasGraph_graphDijkstras(__pyx_v_dists2Tot, __pyx_v_visitMat, __pyx_v_dists2, __pyx_v_current_, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 27; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("graphDijkstras"), (PyCFunction)__pyx_pf_14dijkstrasGraph_graphDijkstras, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#endif
{
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_dijkstrasGraph(void)");
  ...
  if (__pyx_module_is_main_dijkstrasGraph) {
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init dijkstrasGraph", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init dijkstrasGraph");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
