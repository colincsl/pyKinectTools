/* Generated by Cython 0.16 on Tue Aug 28 16:04:32 2012 */
...
#endif
#include <math.h>
#define __PYX_HAVE__pyKinectTools__algs__NeighborSuperpixels
#define __PYX_HAVE_API__pyKinectTools__algs__NeighborSuperpixels
#include "stdio.h"
#include "stdlib.h"
...
/* "pyKinectTools/algs/NeighborSuperpixels.pyx":9
 * np.import_array()
 * 
 ...
 */
typedef __pyx_t_5numpy_uint8_t __pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8;
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'pyKinectTools.algs.NeighborSuperpixels' */
static CYTHON_INLINE PyObject *__pyx_f_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborEdges(PyArrayObject *, int __pyx_skip_dispatch); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborProfiles(PyArrayObject *, PyObject *, PyObject *, int __pyx_skip_dispatch); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8 = { "UINT8", NULL, sizeof(__pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8), { 0 }, 0, 'U', IS_UNSIGNED(__pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8), 0 };
#define __Pyx_MODULE_NAME "pyKinectTools.algs.NeighborSuperpixels"
int __pyx_module_is_main_pyKinectTools__algs__NeighborSuperpixels = 0;

/* Implementation of 'pyKinectTools.algs.NeighborSuperpixels' */
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_RuntimeError;
static PyObject *__pyx_pf_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborEdges(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_regions); /* proto */
static PyObject *__pyx_pf_13pyKinectTools_4algs_19NeighborSuperpixels_2getNeighborProfiles(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_im, PyObject *__pyx_v_edges, PyObject *__pyx_v_edgePositions); /* proto */
...
static char __pyx_k_13[] = " Build with: python setup.py build_ext --inplace ";
...
static char __pyx_k__edgePositions[] = "edgePositions";
...
static PyObject *__pyx_n_s__edgePositions;
...
/* "pyKinectTools/algs/NeighborSuperpixels.pyx":16
...
static PyObject *__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_1getNeighborEdges(PyObject *__pyx_self, PyObject *__pyx_v_regions); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborEdges(PyArrayObject *__pyx_v_regions, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_x;
  int __pyx_v_y;
  int __pyx_v_ind;
  int __pyx_v_height;
  ...
  __pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8 *__pyx_v_regions_c;
  long __pyx_v_ind2;
  long __pyx_v_ind3;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("getNeighborEdges", 0);
  ...
  __pyx_pybuffernd_regions.rcbuffer = &__pyx_pybuffer_regions;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_regions.rcbuffer->pybuffer, (PyObject*)__pyx_v_regions, &__Pyx_TypeInfo_nn___pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":18
 * cpdef inline list getNeighborEdges(np.ndarray[UINT8, ndim=2] regions):
 * 	cdef int x,y, ind
 * 	cdef int height = regions.shape[0]             # <<<<<<<<<<<<<<
 ...
 * 	cdef list edges = []
 */
  __pyx_v_height = (__pyx_v_regions->dimensions[0]);

  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":19
 * 	cdef int x,y, ind
 * 	cdef int height = regions.shape[0]
 * 	cdef int width = regions.shape[1]             # <<<<<<<<<<<<<<
 * 	cdef list edges = []
 * 
 */
  __pyx_v_width = (__pyx_v_regions->dimensions[1]);

  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":20
 * 	cdef int height = regions.shape[0]
 * 	cdef int width = regions.shape[1]
 * 	cdef list edges = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":22
 * 	cdef list edges = []
 * 
 * 	cdef UINT8* regions_c = <UINT8*>regions.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_regions_c = ((__pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8 *)__pyx_v_regions->data);

  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":25
 * 
 * 	# Look left and above current node. If it is a different label, add to edges.
 ...
 */
  ...
  for (__pyx_t_3 = 1; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":26
 * 	# Look left and above current node. If it is a different label, add to edges.
 * 	for y in range(1, height):
 * 		for x in range(1, width):             # <<<<<<<<<<<<<<
 * 			ind = y*width + x
 ...
 */
    ...
    for (__pyx_t_5 = 1; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":27
 * 	for y in range(1, height):
 * 		for x in range(1, width):
 * 			ind = y*width + x             # <<<<<<<<<<<<<<
 * 			ind2 = (y-1)*width + x # Above
 ...
 */
      __pyx_v_ind = ((__pyx_v_y * __pyx_v_width) + __pyx_v_x);

      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":28
 * 		for x in range(1, width):
 * 			ind = y*width + x
 * 			ind2 = (y-1)*width + x # Above             # <<<<<<<<<<<<<<
 * 			ind3 = y*width + x -1  # Left
 ...
 */
      __pyx_v_ind2 = (((__pyx_v_y - 1) * __pyx_v_width) + __pyx_v_x);

      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":29
 * 			ind = y*width + x
 * 			ind2 = (y-1)*width + x # Above
 * 			ind3 = y*width + x -1  # Left             # <<<<<<<<<<<<<<
 * 			# If not the same label and both labels are not the background (=0)
 ...
 */
      __pyx_v_ind3 = (((__pyx_v_y * __pyx_v_width) + __pyx_v_x) - 1);

      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":31
 * 			ind3 = y*width + x -1  # Left
 * 			# If not the same label and both labels are not the background (=0)
 * 			if regions_c[ind] - regions_c[ind2] != 0 and regions_c[ind] > 0 and regions_c[ind2] > 0:             # <<<<<<<<<<<<<<
 ...
 */
      __pyx_t_6 = (((__pyx_v_regions_c[__pyx_v_ind]) - (__pyx_v_regions_c[__pyx_v_ind2])) != 0);
      if (__pyx_t_6) {
        __pyx_t_7 = ((__pyx_v_regions_c[__pyx_v_ind]) > 0);
        if (__pyx_t_7) {
          __pyx_t_8 = ((__pyx_v_regions_c[__pyx_v_ind2]) > 0);
          __pyx_t_9 = __pyx_t_8;
        } else {
          __pyx_t_9 = __pyx_t_7;
        }
      ...
      if (__pyx_t_7) {
        ...
        /* "pyKinectTools/algs/NeighborSuperpixels.pyx":32
 * 			# If not the same label and both labels are not the background (=0)
 * 			if regions_c[ind] - regions_c[ind2] != 0 and regions_c[ind] > 0 and regions_c[ind2] > 0:
 * 				edges.append([regions_c[ind], regions_c[ind2]])             # <<<<<<<<<<<<<<
 * 			if regions_c[ind] - regions_c[ind3] != 0 and regions_c[ind] > 0 and regions_c[ind3] > 0:
 ...
 */
        __pyx_t_1 = __Pyx_PyInt_to_py_npy_uint8((__pyx_v_regions_c[__pyx_v_ind])); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_1);
        __pyx_t_10 = __Pyx_PyInt_to_py_npy_uint8((__pyx_v_regions_c[__pyx_v_ind2])); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_11 = PyList_New(2); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        ...
        __pyx_t_1 = 0;
        __pyx_t_10 = 0;
        __pyx_t_12 = PyList_Append(__pyx_v_edges, ((PyObject *)__pyx_t_11)); if (unlikely(__pyx_t_12 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 32; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(((PyObject *)__pyx_t_11)); __pyx_t_11 = 0;
        goto __pyx_L7;
      }
      __pyx_L7:;

      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":33
 * 			if regions_c[ind] - regions_c[ind2] != 0 and regions_c[ind] > 0 and regions_c[ind2] > 0:
 * 				edges.append([regions_c[ind], regions_c[ind2]])
 * 			if regions_c[ind] - regions_c[ind3] != 0 and regions_c[ind] > 0 and regions_c[ind3] > 0:             # <<<<<<<<<<<<<<
 * 				edges.append([regions_c[ind], regions_c[ind3]])
 * 
 */
      __pyx_t_7 = (((__pyx_v_regions_c[__pyx_v_ind]) - (__pyx_v_regions_c[__pyx_v_ind3])) != 0);
      if (__pyx_t_7) {
        __pyx_t_6 = ((__pyx_v_regions_c[__pyx_v_ind]) > 0);
        if (__pyx_t_6) {
          __pyx_t_9 = ((__pyx_v_regions_c[__pyx_v_ind3]) > 0);
          __pyx_t_8 = __pyx_t_9;
        } else {
          __pyx_t_8 = __pyx_t_6;
        }
      ...
      if (__pyx_t_6) {
        ...
        /* "pyKinectTools/algs/NeighborSuperpixels.pyx":34
 * 				edges.append([regions_c[ind], regions_c[ind2]])
 * 			if regions_c[ind] - regions_c[ind3] != 0 and regions_c[ind] > 0 and regions_c[ind3] > 0:
 * 				edges.append([regions_c[ind], regions_c[ind3]])             # <<<<<<<<<<<<<<
 * 
 * 	return edges
 */
        __pyx_t_11 = __Pyx_PyInt_to_py_npy_uint8((__pyx_v_regions_c[__pyx_v_ind])); if (unlikely(!__pyx_t_11)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_11);
        __pyx_t_10 = __Pyx_PyInt_to_py_npy_uint8((__pyx_v_regions_c[__pyx_v_ind3])); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        ...
        __pyx_t_11 = 0;
        __pyx_t_10 = 0;
        __pyx_t_12 = PyList_Append(__pyx_v_edges, ((PyObject *)__pyx_t_1)); if (unlikely(__pyx_t_12 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 34; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":36
 * 				edges.append([regions_c[ind], regions_c[ind3]])
 * 
 * 	return edges             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_AddTraceback("pyKinectTools.algs.NeighborSuperpixels.getNeighborEdges", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_regions.rcbuffer->pybuffer);
...
/* Python wrapper */
static PyObject *__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_1getNeighborEdges(PyObject *__pyx_self, PyObject *__pyx_v_regions); /*proto*/
static PyObject *__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_1getNeighborEdges(PyObject *__pyx_self, PyObject *__pyx_v_regions) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getNeighborEdges (wrapper)", 0);
  __pyx_self = __pyx_self;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_regions), __pyx_ptype_5numpy_ndarray, 1, "regions", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborEdges(__pyx_self, ((PyArrayObject *)__pyx_v_regions));
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborEdges(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_regions) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_regions;
  __Pyx_Buffer __pyx_pybuffer_regions;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_t_1 = ((PyObject *)__pyx_f_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborEdges(__pyx_v_regions, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "pyKinectTools/algs/NeighborSuperpixels.pyx":39
 * 
 * 
...
static PyObject *__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_3getNeighborProfiles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static CYTHON_INLINE PyObject *__pyx_f_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborProfiles(PyArrayObject *__pyx_v_im, PyObject *__pyx_v_edges, PyObject *__pyx_v_edgePositions, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_ind;
  CYTHON_UNUSED int __pyx_v_height;
  int __pyx_v_width;
  __pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8 *__pyx_v_im_c;
  PyObject *__pyx_v_edgeProfiles = 0;
  int __pyx_v_currentX;
  int __pyx_v_currentY;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("getNeighborProfiles", 0);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_im.rcbuffer->pybuffer, (PyObject*)__pyx_v_im, &__Pyx_TypeInfo_nn___pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":41
 * cpdef inline list getNeighborProfiles(np.ndarray[UINT8, ndim=2] im, list edges, list edgePositions):
 * 	cdef int x,y, ind, dist
 * 	cdef int height = im.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":42
 * 	cdef int x,y, ind, dist
 * 	cdef int height = im.shape[0]
 * 	cdef int width = im.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":44
 * 	cdef int width = im.shape[1]
 * 
 * 	cdef UINT8* im_c = <UINT8*>im.data             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_im_c = ((__pyx_t_13pyKinectTools_4algs_19NeighborSuperpixels_UINT8 *)__pyx_v_im->data);

  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":46
 * 	cdef UINT8* im_c = <UINT8*>im.data
 * 
 * 	cdef list edgeProfiles = []             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_v_edgeProfiles = __pyx_t_1;
  __pyx_t_1 = 0;

  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":49
 * 
 * 	cdef int currentX, currentY
 * 	for e in edges:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_1 = ((PyObject *)__pyx_v_edges); __Pyx_INCREF(__pyx_t_1); __pyx_t_2 = 0;
  for (;;) {
    ...
    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":50
 * 	cdef int currentX, currentY
 * 	for e in edges:
 * 		currentY = edgePositions[e[0]][0]             # <<<<<<<<<<<<<<
 * 		currentX = edgePositions[e[0]][1]
 ...
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_e, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_GetItem(((PyObject *)__pyx_v_edgePositions), __pyx_t_3); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_4, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_5 = __Pyx_PyInt_AsInt(__pyx_t_3); if (unlikely((__pyx_t_5 == (int)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 50; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_currentY = __pyx_t_5;

    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":51
 * 	for e in edges:
 * 		currentY = edgePositions[e[0]][0]
 * 		currentX = edgePositions[e[0]][1]             # <<<<<<<<<<<<<<
 * 		endY = edgePositions[e[1]][0]
 ...
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_e, 0, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_GetItem(((PyObject *)__pyx_v_edgePositions), __pyx_t_3); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_4, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 51; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    ...
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_v_currentX = __pyx_t_5;

    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":52
 * 		currentY = edgePositions[e[0]][0]
 * 		currentX = edgePositions[e[0]][1]
 * 		endY = edgePositions[e[1]][0]             # <<<<<<<<<<<<<<
 * 		endX = edgePositions[e[1]][1]
 * 
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_e, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_GetItem(((PyObject *)__pyx_v_edgePositions), __pyx_t_3); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 52; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_v_endY = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":53
 * 		currentX = edgePositions[e[0]][1]
 * 		endY = edgePositions[e[1]][0]
 * 		endX = edgePositions[e[1]][1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_e, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyObject_GetItem(((PyObject *)__pyx_v_edgePositions), __pyx_t_3); if (!__pyx_t_4) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = __Pyx_GetItemInt(__pyx_t_4, 1, sizeof(long), PyInt_FromLong); if (!__pyx_t_3) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 53; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_XDECREF(__pyx_v_endX);
    __pyx_v_endX = __pyx_t_3;
    __pyx_t_3 = 0;

    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":55
 * 		endX = edgePositions[e[1]][1]
 * 
 * 		ind = currentY*width + currentX             # <<<<<<<<<<<<<<
 ...
 * 
 */
    __pyx_v_ind = ((__pyx_v_currentY * __pyx_v_width) + __pyx_v_currentX);

    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":56
 * 
 * 		ind = currentY*width + currentX
 * 		edgeProfiles.append([im_c[ind]])             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_3 = __Pyx_PyInt_to_py_npy_uint8((__pyx_v_im_c[__pyx_v_ind])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    ...
    __pyx_t_3 = 0;
    __pyx_t_6 = PyList_Append(__pyx_v_edgeProfiles, ((PyObject *)__pyx_t_4)); if (unlikely(__pyx_t_6 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 56; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_DECREF(((PyObject *)__pyx_t_4)); __pyx_t_4 = 0;

    /* "pyKinectTools/algs/NeighborSuperpixels.pyx":58
 * 		edgeProfiles.append([im_c[ind]])
 * 
 * 		while currentX != endX and currentY != endY:             # <<<<<<<<<<<<<<
 ...
 */
    while (1) {
      __pyx_t_4 = PyInt_FromLong(__pyx_v_currentX); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = PyObject_RichCompare(__pyx_t_4, __pyx_v_endX, Py_NE); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      ...
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      if (__pyx_t_7) {
        __pyx_t_3 = PyInt_FromLong(__pyx_v_currentY); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_4 = PyObject_RichCompare(__pyx_t_3, __pyx_v_endY, Py_NE); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 58; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      ...
      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":59
 * 
 * 		while currentX != endX and currentY != endY:
 * 			if abs(currentX - endX) > abs(currentY - endY):             # <<<<<<<<<<<<<<
 * 				if currentX > endX:
 * 					currentX -= 1
 */
      __pyx_t_4 = PyInt_FromLong(__pyx_v_currentX); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __pyx_t_3 = PyNumber_Subtract(__pyx_t_4, __pyx_v_endX); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __pyx_t_4 = PyNumber_Absolute(__pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = PyInt_FromLong(__pyx_v_currentY); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_10 = PyNumber_Subtract(__pyx_t_3, __pyx_v_endY); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_3 = PyNumber_Absolute(__pyx_t_10); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __pyx_t_10 = PyObject_RichCompare(__pyx_t_4, __pyx_t_3, Py_GT); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __pyx_t_9 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_9 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 59; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      if (__pyx_t_9) {

        /* "pyKinectTools/algs/NeighborSuperpixels.pyx":60
 * 		while currentX != endX and currentY != endY:
 * 			if abs(currentX - endX) > abs(currentY - endY):
 * 				if currentX > endX:             # <<<<<<<<<<<<<<
 * 					currentX -= 1
 * 				else:
 */
        __pyx_t_10 = PyInt_FromLong(__pyx_v_currentX); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __pyx_t_3 = PyObject_RichCompare(__pyx_t_10, __pyx_v_endX, Py_GT); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        __pyx_t_9 = __Pyx_PyObject_IsTrue(__pyx_t_3); if (unlikely(__pyx_t_9 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 60; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        if (__pyx_t_9) {

          /* "pyKinectTools/algs/NeighborSuperpixels.pyx":61
 * 			if abs(currentX - endX) > abs(currentY - endY):
 * 				if currentX > endX:
 * 					currentX -= 1             # <<<<<<<<<<<<<<
 * 				else:
 * 					currentX += 1
 */
          __pyx_v_currentX = (__pyx_v_currentX - 1);
          goto __pyx_L8;
        }
        /*else*/ {

          /* "pyKinectTools/algs/NeighborSuperpixels.pyx":63
 * 					currentX -= 1
 * 				else:
 * 					currentX += 1             # <<<<<<<<<<<<<<
 * 			else:
 ...
 */
      ...
      /*else*/ {
        ...
        /* "pyKinectTools/algs/NeighborSuperpixels.pyx":65
 * 					currentX += 1
 * 			else:
 * 				if currentY > endY:             # <<<<<<<<<<<<<<
 * 					currentY -= 1
 * 				else:
 */
        __pyx_t_3 = PyInt_FromLong(__pyx_v_currentY); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_10 = PyObject_RichCompare(__pyx_t_3, __pyx_v_endY, Py_GT); if (unlikely(!__pyx_t_10)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_GOTREF(__pyx_t_10);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_9 = __Pyx_PyObject_IsTrue(__pyx_t_10); if (unlikely(__pyx_t_9 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 65; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
        __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
        if (__pyx_t_9) {

          /* "pyKinectTools/algs/NeighborSuperpixels.pyx":66
 * 			else:
 * 				if currentY > endY:
 * 					currentY -= 1             # <<<<<<<<<<<<<<
 * 				else:
 * 					currentY += 1
 */
          __pyx_v_currentY = (__pyx_v_currentY - 1);
          goto __pyx_L9;
        }
        /*else*/ {

          /* "pyKinectTools/algs/NeighborSuperpixels.pyx":68
 * 					currentY -= 1
 * 				else:
 * 					currentY += 1             # <<<<<<<<<<<<<<
 * 			ind = currentY*width + currentX
 ...
 */
      ...
      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":69
 * 				else:
 * 					currentY += 1
 * 			ind = currentY*width + currentX             # <<<<<<<<<<<<<<
 * 			edgeProfiles[-1].append(im_c[ind])
 ...
 */
      ...
      /* "pyKinectTools/algs/NeighborSuperpixels.pyx":70
 * 					currentY += 1
 * 			ind = currentY*width + currentX
 * 			edgeProfiles[-1].append(im_c[ind])             # <<<<<<<<<<<<<<
 * 
 * 	return edgeProfiles
 */
      __pyx_t_10 = __Pyx_GetItemInt_List(((PyObject *)__pyx_v_edgeProfiles), -1, sizeof(long), PyInt_FromLong); if (!__pyx_t_10) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_10);
      __pyx_t_3 = __Pyx_PyInt_to_py_npy_uint8((__pyx_v_im_c[__pyx_v_ind])); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_3);
      __pyx_t_4 = __Pyx_PyObject_Append(__pyx_t_10, __pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 70; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_10); __pyx_t_10 = 0;
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":72
 * 			edgeProfiles[-1].append(im_c[ind])
 * 
 * 	return edgeProfiles             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __Pyx_INCREF(((PyObject *)__pyx_v_edgeProfiles));
  __pyx_r = __pyx_v_edgeProfiles;
  goto __pyx_L0;
  ...
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("pyKinectTools.algs.NeighborSuperpixels.getNeighborProfiles", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_im.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF(__pyx_v_edgeProfiles);
  __Pyx_XDECREF(__pyx_v_e);
  __Pyx_XDECREF(__pyx_v_endY);
  __Pyx_XDECREF(__pyx_v_endX);
  __Pyx_XGIVEREF(__pyx_r);
...
/* Python wrapper */
static PyObject *__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_3getNeighborProfiles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_3getNeighborProfiles(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_im = 0;
  PyObject *__pyx_v_edges = 0;
  PyObject *__pyx_v_edgePositions = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__im,&__pyx_n_s__edges,&__pyx_n_s__edgePositions,0};
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getNeighborProfiles (wrapper)", 0);
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  1:
        values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__edges);
        if (likely(values[1])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("getNeighborProfiles", 1, 3, 3, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__edgePositions);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("getNeighborProfiles", 1, 3, 3, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "getNeighborProfiles") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_edgePositions = ((PyObject*)values[2]);
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("getNeighborProfiles", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("pyKinectTools.algs.NeighborSuperpixels.getNeighborProfiles", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_im), __pyx_ptype_5numpy_ndarray, 1, "im", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_edges), (&PyList_Type), 1, "edges", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_edgePositions), (&PyList_Type), 1, "edgePositions", 1))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_r = __pyx_pf_13pyKinectTools_4algs_19NeighborSuperpixels_2getNeighborProfiles(__pyx_self, __pyx_v_im, __pyx_v_edges, __pyx_v_edgePositions);
  goto __pyx_L0;
  __pyx_L1_error:;
  __pyx_r = NULL;
  __pyx_L0:;
...
static PyObject *__pyx_pf_13pyKinectTools_4algs_19NeighborSuperpixels_2getNeighborProfiles(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_im, PyObject *__pyx_v_edges, PyObject *__pyx_v_edgePositions) {
  __Pyx_LocalBuf_ND __pyx_pybuffernd_im;
  __Pyx_Buffer __pyx_pybuffer_im;
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  __pyx_pybuffernd_im.diminfo[0].strides = __pyx_pybuffernd_im.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_im.diminfo[0].shape = __pyx_pybuffernd_im.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_im.diminfo[1].strides = __pyx_pybuffernd_im.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_im.diminfo[1].shape = __pyx_pybuffernd_im.rcbuffer->pybuffer.shape[1];
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_13pyKinectTools_4algs_19NeighborSuperpixels_getNeighborProfiles(__pyx_v_im, __pyx_v_edges, __pyx_v_edgePositions, 0)); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 39; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("getNeighborEdges"), (PyCFunction)__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_1getNeighborEdges, METH_O, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("getNeighborProfiles"), (PyCFunction)__pyx_pw_13pyKinectTools_4algs_19NeighborSuperpixels_3getNeighborProfiles, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    __Pyx_NAMESTR("NeighborSuperpixels"),
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__edgePositions, __pyx_k__edgePositions, sizeof(__pyx_k__edgePositions), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initNeighborSuperpixels(void); /*proto*/
PyMODINIT_FUNC initNeighborSuperpixels(void)
#else
PyMODINIT_FUNC PyInit_NeighborSuperpixels(void); /*proto*/
PyMODINIT_FUNC PyInit_NeighborSuperpixels(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_NeighborSuperpixels(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("NeighborSuperpixels"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_13), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_pyKinectTools__algs__NeighborSuperpixels) {
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":3
 ...
 */
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":7
 * from libc.math cimport abs
 * 
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "pyKinectTools/algs/NeighborSuperpixels.pyx":1
 * ''' Build with: python setup.py build_ext --inplace '''             # <<<<<<<<<<<<<<
 * 
 * import numpy as np
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init pyKinectTools.algs.NeighborSuperpixels", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init pyKinectTools.algs.NeighborSuperpixels");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
